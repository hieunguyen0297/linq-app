...
namespace LinqSyn
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int[] scores = {50,23, 40, 60, 70, 76, 88, 91, 100, 99, 66, 45, 94, 97, 92, 86};
            //Print them out
            // foreach(int score in scores){
            //     Console.WriteLine(score);
            // }

            //Pause the application so we can see the scores
            //Console.ReadLine();

            //Use LINQ to filter the list
            //Need to import System.Linq in order to use linq query;
            var theBestStudents = from item in scores where item > 90 select item;

            //Not sorted list
            // foreach(int score in theBestStudents){
            //     Console.WriteLine(score);
            // }

            //Show a sorted list // add descending after "oderby item" to go from largest to smallest
            var sortedScores = from item in scores orderby item where item > 90 select item;
            ...
            var bStudents = from item in scores where item >= 80 && item < 89 select item;
            // foreach(int score in bStudents){
            //     Console.WriteLine(score);
            // }
            ...
            Console.WriteLine("Rich Actors: ");
            PrintList(richActors);
        }

        //Make a new method to print the list
